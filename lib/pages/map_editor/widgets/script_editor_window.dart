...
class ScriptEditorWindow extends StatefulWidget {
  ...
  @override
  State<ScriptEditorWindow> createState() => _ScriptEditorWindowState();
}

class _ScriptEditorWindowState extends State<ScriptEditorWindow> {
