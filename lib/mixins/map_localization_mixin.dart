...
mixin MapLocalizationMixin {
  ...
  Future<String> getLocalizedMapTitle(
    ...
    // 先尝试完整的语言代码
    String? translation = await _localizationService.getMapTranslation(
      originalTitle,
      fullLanguageCode,
    );
    ...
    // 如果没找到，尝试只用语言代码
    if (translation == null) {
      translation = await _localizationService.getMapTranslation(
        originalTitle,
        languageCode,
      );
    }
  ...
  /// 批量获取本地化标题
  Future<Map<String, String>> getLocalizedMapTitles(
