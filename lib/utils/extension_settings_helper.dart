...
class ExtensionSettingsHelper {
  ...
  bool getLegendGroupSmartHide(String mapId, String legendGroupId) {
    final key = '${ExtensionSettingsKeys.legendGroupSmartHide}.$mapId.$legendGroupId';
...
class ExtensionSettingsManager {
  ...
  static ExtensionSettingsHelper get instance {
    if (_helper == null) {
      throw StateError('ExtensionSettingsManager not initialized. Call initialize() first.');
    }
    return _helper!;
  }
