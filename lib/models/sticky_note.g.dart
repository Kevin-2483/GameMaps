...
StickyNote _$StickyNoteFromJson(Map<String, dynamic> json) => StickyNote(
      ...
      titleBarColor: json['titleBarColor'] == null
          ...
          : const ColorConverter()
              .fromJson((json['titleBarColor'] as num).toInt()),
      textColor: json['textColor'] == null
          ? const Color(0xFF424242)
          : const ColorConverter().fromJson((json['textColor'] as num).toInt()),
      backgroundImageData: const Uint8ListConverter()
          .fromJson(json['backgroundImageData'] as String?),
...
Map<String, dynamic> _$StickyNoteToJson(StickyNote instance) =>
    <String, dynamic>{
      ...
      'backgroundImageData':
          const Uint8ListConverter().toJson(instance.backgroundImageData),
