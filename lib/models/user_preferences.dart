...
class MapEditorPreferences {
  ...
  /// 默认图例大小 (0: 使用动态公式 1/(缩放*系数), 0.1-3: 直接使用固定值)
  final double defaultLegendSize;
  ...
  factory MapEditorPreferences.createDefault() {
    return const MapEditorPreferences(
      ...
      shortcuts: {
        ...
        'nextLayer': ['N'],
        'prevLayerGroup': ['Left'],
        'nextLayerGroup': ['Right'],
        'prevLegendGroup': ['Up'],
        'nextLegendGroup': ['Down'],
        'openLegendDrawer': ['L'],
        'clearLayerSelection': ['Escape'],
        // 新增快捷键
        'toggleSidebar': ['Ctrl+B', 'Win+B'],
        'openZInspector': ['Z'],
        'toggleLegendGroupDrawer': ['G'],
        'hideOtherLayers': ['H'],
        'hideOtherLayerGroups': ['Alt+H'],
        'showCurrentLayer': ['S'],
        'showCurrentLayerGroup': ['Alt+S'],
        'hideOtherLegendGroups': ['Ctrl+Alt+H'],
        'showCurrentLegendGroup': ['Ctrl+Alt+S'],
        // 版本管理快捷键
        'prevVersion': ['Ctrl+Left', 'Win+Left'],
        'nextVersion': ['Ctrl+Right', 'Win+Right'],
        'createNewVersion': ['Ctrl+N', 'Win+N'],
        // 图层组选择快捷键 (数字键1-0)
        'selectLayerGroup1': ['1'],
        'selectLayerGroup2': ['2'],
        'selectLayerGroup3': ['3'],
  ...
  MapEditorPreferences copyWith({
    ...
    return MapEditorPreferences(
      ...
      defaultLegendSize: defaultLegendSize ?? this.defaultLegendSize,
    );
  }
