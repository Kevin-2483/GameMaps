...
class CollaborationIntegrationExample extends StatefulWidget {
  ...
  @override
  State<CollaborationIntegrationExample> createState() => _CollaborationIntegrationExampleState();
}

class _CollaborationIntegrationExampleState extends State<CollaborationIntegrationExample> {
      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<CollaborationStateBloc, CollaborationStateBlocState>(
            bloc: _collaborationBloc,
            builder: (context, state) {
              if (state is CollaborationStateLoaded && _selectedElementId != null) {
                final lockState = state.getElementLockState(_selectedElementId!);
                if (lockState != null && lockState.userId == state.currentUserId) {
                  return ElevatedButton(
                    onPressed: () {
                      _collaborationBloc.add(UnlockElement(
  ...
  void _showConflictDialog(BuildContext context, CollaborationStateLoaded state) {
    showDialog(
      context: context,
